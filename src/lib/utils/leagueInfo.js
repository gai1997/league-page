/*   STEP 1   */
export const leagueID = "650051929166147584"; // your league ID
export const leagueName = "Hauschka's Heroes Dynasty League"; // your league name
...
export const managers = [
    {
      ...
      "rival": {
        name: "Drew Feinburg", // Can be anything (usually your rival's name)
    ...
    },
    {
      ...
      "bio": "GO PACK GO!",
      "photo": "/managers/quinn.jpg", // square ratio recommended (no larger than 500x500)
      "favoriteTeam": "gb", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Josh Silverman", // Can be anything (usually your rival's name)
      ...
      "preferredContact": "Manager of the Kamarcans! Go Rodgers!", // 'Text', 'WhatsApp', 'Sleeper', 'Email', 'Phone', 'Discord', and 'Carrier Pigeon' are currently supplied in the template
    },
    {
      "roster": 10,  // ID of the roster that the manager manages (look at the order of the power rankings graph)
      "name": "Jake Mendelson",
      "tookOver": 2019, // (optional) used if a manager took over a team, delete this line or change to null otherwise
      "location": "Boston, Massachusetts", // (optional)
      "bio": "Owner of the great Kupp Checks!",
      "photo": "/managers/jake.jpg", // square ratio recommended (no larger than 500x500)
      "favoriteTeam": "nyg", // (optional) favorite NFL team, (follows convention: nyj, sea, mia, etc.) MUST BE LOWERCASE
      "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
      "rival": {
        name: "Jonathan Banks", // Can be anything (usually your rival's name)
        link: 6, // manager array number within this array, or null to link back to all managers page
        image: "/managers/banks.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
      },
